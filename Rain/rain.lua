...
rain.dropColor = config.color or 255/255
end
-- Drops
...
--drop.width = rain.dropWidth -- width is deprecated use strokeWidth instead
--drop:setColor( rain.dropColor ) --setColor is deprecated use setStrokeColor instead
